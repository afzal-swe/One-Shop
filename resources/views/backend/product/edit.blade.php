                  ...
                  <div class="">  
                    ...
                    <div class="card-header">
                     ...
                     <div class="card p-4">
                       ...
                       <div><span> Status </span> <input type="checkbox" name="featured" value="1" data-bootstrap-switch data-off-color="danger" data-on-color="success" class="btn" style="margin-left: 20px;"></div>
                       {{-- <div><span> Status </span> <input type="checkbox" name="featured" value="1" @if ($product->featured==1) checked @endif data-bootstrap-switch data-off-color="danger" data-on-color="success" class="btn" style="margin-left: 20px;"></div> --}}
                     </div>

                     <div class="card p-4">
                        <h6>Today Deal</h6><hr>
                        <div><span> Status </span> <input type="checkbox" name="today_deal" value="1" data-bootstrap-switch data-off-color="danger" data-on-color="success" class="btn" style="margin-left: 20px;"></div>
                     </div>

                     <div class="card p-4">
                        <h6>New Arrivals</h6><hr>
                       <div><span> Status </span> <input type="checkbox" name="hot_new_arrivals" value="1" data-bootstrap-switch data-off-color="danger" data-on-color="success" class="btn" style="margin-left: 20px;"></div>
                     </div>

                     <div class="card p-4">
                        <h6>Best Sellers</h6><hr>
                       <div><span> Status </span> <input type="checkbox" name="hot_best_sellers" value="1" data-bootstrap-switch data-off-color="danger" data-on-color="success" class="btn" style="margin-left: 20px;"></div>
                     </div>
                     ...
                     <div class="card p-4">
                       ...
                       <div><span> Status </span> <input type="checkbox" name="cash_on_delivery" value="1" data-bootstrap-switch data-off-color="danger" data-on-color="success" class="btn" style="margin-left: 20px;"></div>
                     </div>

                     <div class="card p-4">
                        <h6>Product Publication</h6><hr>
                       <div><span> Status </span> <input type="checkbox" name="status" value="1" data-bootstrap-switch data-off-color="danger" data-on-color="success" class="btn" style="margin-left: 20px;"></div>
                     </div>
