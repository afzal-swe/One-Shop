                                    ...
                                    <form action="{{ route('seo.store') }}" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="meta_author" class="form-control" value="{{ old('meta_author') }}" required>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="google_analytics" class="form-control" value="{{ old('google_analytics') }}" required>
                                            </div>

                                            <div class="form-group">
                                                <label for="">Google Verification</label>
                                                <input type="text" name="google_verification" class="form-control" value="{{ old('google_verification') }}" required>
                                            </div>

                                            <div class="form-group">
                                                <label for="">Alexa Analytics</label>
                                                <input type="text" name="alexa_analytics" class="form-control" value="{{ old('alexa_analytics') }}" required>
                                            </div>
